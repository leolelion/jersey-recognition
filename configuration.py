...
dataset = {'SoccerNet':
                {'root_dir': './data/SoccerNet',
                 ...
                 'legibility_model': "models/legibility_resnet50_20250318-192756.pth",
                 'legibility_model_arch': "resnet50",
                 ...
                 'str_model': 'models/parseq_epoch=20-step=2163-val_accuracy=95.3984-val_NED=96.2569.ckpt',
